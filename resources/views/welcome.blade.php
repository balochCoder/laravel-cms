                                    ...
                                    <div class="card border hover-shadow-6 mb-6 d-block">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h5 class="mb-0"><a class="text-dark"
                                                    href="{{route('blog.post',$post->id)}}">{{ $post->title }}</a></h5>
                                        </div>
                                    </div>
                                </div>
                            @endforeach   
                    ...
                    <div class="col-md-4 col-xl-3">
                        <div class="sidebar px-4 py-md-0">
                            ...
                            <a class="media text-default align-items-center mb-5" href="blog-single.html">
                                ...
                                <p class="media-body small-2 lh-4 mb-0">Top 5 brilliant content marketing strategies
                                </p>
                            </a>
                            ...
                            <p class="small-3">TheSaaS is a responsive, professional, and multipurpose SaaS,
                                Software, Startup and WebApp landing template powered by Bootstrap 4. TheSaaS is a
                                powerful and super flexible tool for any kind of landing pages.</p> --}}
